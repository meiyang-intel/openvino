...
static const std::vector<std::string> models{std::string("argmax"),
                                             ...
                                             std::string("elementwise_add5"),
                                             std::string("elementwise_div5"),
                                             std::string("elementwise_max5"),
                                             std::string("elementwise_min5"),
                                             std::string("elementwise_mul5"),
                                             std::string("elementwise_pow5"),
                                             std::string("elementwise_sub5"),
